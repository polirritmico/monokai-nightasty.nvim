...
function M.get(c, opts)
  ...
  local ret = {
    ...
    SnacksDashboardFooter = { fg = c.comment, italic = opts.italics }, -- Footer text ("Title")
    ...
    SnacksDashboardSpecial = { fg = c.grey_light, italic = opts.italics }, -- Special elements ("Special")
