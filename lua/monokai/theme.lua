...
function M.setup()
  ...
  theme.highlights = {
    ...
    TabLineSel = { fg = c.comment, bg = c.bg_highlight }, -- tab pages line, active tab page label
    ...
    Keyword = { fg = c.magenta, italic = false }, --  any other keyword
    Exception = { fg = c.magenta, bold = true }, --  try, catch, throw

    PreProc = { fg = c.comment }, -- (preferred) generic Preprocessor
    ...
    markdownHeadingDelimiter = { fg = c.magenta, bold = true },
    ...
    ["@punctuation.bracket"] = { fg = c.magenta, italic = false }, -- For brackets and parens.
    ["@punctuation.special"] = { fg = c.magenta }, -- For special punctutation that does not fall in the catagories before.
    ...
    --- Functions
    ["@constructor"] = { fg = c.blue, italic = false }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ...
    ["@keyword.function"] = { fg = c.blue, italic = true }, -- For keywords used to define a fuction.
    ["@keyword.return"] = { fg = c.magenta, italic = false }, -- For keywords used to define a fuction.
    ...
    ["@variable.field"] = { fg = c.orange, style = options.styles.variables }, -- Any variable name that does not have another highlight.
    ["@variable.builtin"] = { fg = c.comment, italic = true }, -- Variable names that are defined by the languages, like `this` or `self`.
